...
public class CovidData {
    ...
    /*
    COVID information (cases & deaths) was collected
    */
    private String date;
    
    /*
    COVID information is organised by (London) borough
    */
    private String borough;
    
    
    /*
    COVID information that's collected daily for each London borough
    */
